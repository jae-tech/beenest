...
export const SupplierPerformance = memo(
  ({ suppliers, transactions, className = "" }: SupplierPerformanceProps) => {
            ...
            <div style={{ width: "100%", height: 300 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topSuppliers} layout="horizontal">
                  ...
                  <Bar dataKey="overallScore" fill="#3b82f6" name="종합점수" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Card>
                  ...
                  >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          ...
                          {metric.lastOrderDate
                            ? new Date(metric.lastOrderDate).toLocaleDateString(
                                "ko-KR"
                              )
                            : "없음"}
                        </p>
                    ...
                    <td className="py-4 px-4">
                      <span
                        ...
                        style={{
                          backgroundColor: PERFORMANCE_COLORS[metric.status],
                        }}
                      >
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start space-x-2">
                  ...
                  <span>우수 거래처와의 장기 계약 검토</span>
                </li>
                <li className="flex items-start space-x-2">
                  <TrendingUp className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                  <span>우선 거래처로 더 많은 주문 할당</span>
                </li>
                <li className="flex items-start space-x-2">
