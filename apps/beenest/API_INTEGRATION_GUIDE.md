...
- Console에서 "API Client initialized with baseURL: " 메시지 확인
...
- [ ] 통계 데이터 로딩 (GET /dashboard/stats)
- [ ] 차트 데이터 로딩 (GET /dashboard/charts)
- [ ] 자동 새로고침 동작
