...
import type { Transaction, TransactionItem, TransactionStats, TransactionSummary, TransactionFilters } from '../entities/transaction'
...
export interface TransactionSearchParams {
  page?: number
  limit?: number
  search?: string          // 거래번호, 고객명, 공급업체명 검색
